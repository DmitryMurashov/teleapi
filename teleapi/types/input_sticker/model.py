...
class InputStickerModel(InputFileModel):
    ...
    emoji_list: List[str] = ListModelField(StringModelField(), min_size=1, max_size=20)
    keywords: List[str] = ListModelField(StringModelField(max_size=64), is_required=False, max_size=20)
